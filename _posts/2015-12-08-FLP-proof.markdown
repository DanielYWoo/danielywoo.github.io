...
关于异步网络和故障模型, 请参考<a href="http://danielw.cn/network-failure-models/">http://danielw.cn/network-failure-models/</a>.
...
进程之间通过消息通信, 一个消息e = (p, m). 其中p是目标进程, m是消息值. 整个消息系统叫做message buffer, 相当于一个multiset(每个进程拥有自己的消息队列, 如同erlang信箱一样). message buffer里包含着已经发出但是还没有收到的消息. message buffer支持两个操作:
...
<img src="/images/2015-12-08/lemma3_sample.png" max-height="500px">
...
<img src="/images/2015-12-08/lemma3_sample_2a.png" max-height="500px">
...
<img src="/images/2015-12-08/lemma3_sample_2b.png" max-height="500px">
...
<img src="/images/2015-12-08/lemma3_sample_2c.png" max-height="500px">
